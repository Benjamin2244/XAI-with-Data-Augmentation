...
def show_SHAP_differences(feature_differences, total_difference, order, dataset, feature_names):
    display_feature_differences(feature_differences, order, dataset, feature_names)
    display_total_differences(total_difference, order, dataset, feature_names)
...
def analyse_shap(all_shap_results, all_feature_names):
    for dataset in all_shap_results:
        ...
        # GAN_comparison = compare_results(control_results, GAN_results)

        show_SHAP_differences(SMOTE_feature_differences, SMOTE_total_difference, SMOTE_order, dataset, feature_names)
